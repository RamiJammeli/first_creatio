define("Usr_RealtyClassic1Page", [], function() {
	return {
		...
		details: /**SCHEMA_DETAILS*/{
			"Files": {
				...
				"filter": {
					"masterColumn": "Id",
					"detailColumn": "Usr_RealtyClassic"
				}
			}
		}/**SCHEMA_DETAILS*/,
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrNamea50c68c5-8310-4fdb-93d7-d98d1e5fa390",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATe5946fca-f611-4317-9329-59af59786802",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT7a6d138a-f67c-4824-b4ac-1e8ca1e8219e",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPff2c8141-1899-4407-bde7-71692ea587db",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPcc465458-08dc-4818-8b31-af254f4ee926",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
