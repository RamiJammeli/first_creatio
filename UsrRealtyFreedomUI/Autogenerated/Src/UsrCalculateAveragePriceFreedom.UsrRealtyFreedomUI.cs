namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAveragePriceFreedomMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAveragePriceFreedomMethodsWrapper : ProcessModel
	{

		public UsrCalculateAveragePriceFreedomMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var offerTypeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "UsrOffer", offerTypeId);
