define("UsrRealtyClassicMig_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "c2156062-3129-ee70-a5de-cab923fbe279",
							"code": "PDS_UsrType",
							"path": "UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10,
							"referenceSchemaName": "UsrRealTypeClassic"
						},
						{
							"id": "69eafc90-9b8d-1fd3-7625-ba0650653175",
						...
						{
							"id": "65aee33c-6eda-9292-6ec8-028049a28e53",
						...
						{
							"id": "fe9a8261-4fa1-235e-482d-49e72b5d37c2",
							"code": "PDS_CreatedOn",
							"path": "CreatedOn",
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "Usr_RealtyClassic",
					"layoutConfig": {
						"width": 328.125
					},
					"classes": [
				...
				"values": {
					"dataSources": {
						"PDS": {
							...
							"config": {
								"entitySchemaName": "Usr_RealtyClassic",
								"attributes": {
									"UsrName": {
										"path": "UsrName"
									},
