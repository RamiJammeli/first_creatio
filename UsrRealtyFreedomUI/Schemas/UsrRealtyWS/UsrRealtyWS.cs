namespace Terrasoft.Configuration
{
    ...
    public class UsrRealtyWS : BaseService, IReadOnlySessionState
    {
        [OperationContract]
            ...
            string entityName)
        {
            ...
            Select select = new Select(UserConnection)
                ...
                .From(entityName)
                .Where("UsrType").IsEqual(Column.Parameter(new Guid(realtyTypeId)))
                .And("UsrOffer").IsEqual(Column.Parameter(new Guid(realtyOfferTypeId)))
                as Select;
